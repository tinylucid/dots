...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(highlight ((,class (:foreground "white" :background "blue2"))))
   `(hl-line ((,class (:background  ,hl))))
   `(fringe ((,class (:background ,bg2 :foreground ,fg4))))
   `(cursor ((,class (:background "#ff0088"))))
   `(isearch ((,class (:foreground ,bg1 :background "#eb0"))))
   `(mode-line ((,class (:foreground ,comment :background ,bg3))))
   `(mode-line-inactive ((,class (:foreground ,fg4 :background ,bg2 :weight normal))))
   `(font-lock-comment-face ((,class (:foreground ,comment))))
   `(font-lock-string-face ((,class (:foreground ,string))))
   `(org-link ((,class (:underline '(:color ,fg1)))))
   `(ctrlf-highlight-active ((,class (:foreground ,bg1 :background "#eb0"))))
   `(ctrlf-highlight-passive ((,class (:foreground ,bg1 :background "#ff0070"))))
